...
const responseOfficerSchema = new mongoose.Schema({
  name:   { type: String, required: true, trim: true },
  phone:  { type: String, default: '', trim: true },
  email:  { type: String, default: '', trim: true, lowercase: true },
  role:   { type: String, default: '', trim: true },
  // Defaults to inactive — a response officer can only be made active once
  // phone, email, and role are all filled in (enforced in routes/responseOfficers.js).
...
module.exports = mongoose.model('ResponseOfficer', responseOfficerSchema);
